            ...
            <div id="haut"><h1>photos.be</h1> 
                <div id="connect">
                    ...
                    if (!isset($_SESSION['sid']) || $_SESSION['sid'] != session_id()) {
                        ...
                        // texte d'accueil
                        echo "<h3>Bienvenue ".$_SESSION['u.lenom'].'</h3>';
                        echo "<p>Vous êtes connecté en tant que <span title='".$_SESSION['d.lenom']."</span></p>";
                        ...
                        switch($_SESSION['laperm']){
                            ...
                            // si autre droit (ici simple utilisateur)
                             case 2:
                                echo "<a href='modere.php'>Utilisateur1 du site</a> - <a href='membre.php'>Espace membre</a>";
                                break;
                            default :
