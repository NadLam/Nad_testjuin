...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 25 Juin 2015 à 13:35
...
CREATE TABLE IF NOT EXISTS `droit` (
  ...
  `laperm` smallint(100) unsigned DEFAULT '2',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `photo` (
  ...
  `affiche` smallint(100) unsigned DEFAULT '2',
  `utilisateur_id` int(10) unsigned NOT NULL,
  `utilisateur_id1` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `lenom_UNIQUE` (`lenom`),
  KEY `fk_photo_utilisateur1_idx` (`utilisateur_id1`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `valide` tinyint(100) unsigned DEFAULT '1',
  `droit_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `Lelogin_UNIQUE` (`lelogin`),
  KEY `fk_utilisateur_droit1_idx` (`droit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `photo`
  ADD CONSTRAINT `fk_photo_utilisateur1` FOREIGN KEY (`utilisateur_id1`) REFERENCES `utilisateur` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `photo_has_rubriques`
  ...
  ADD CONSTRAINT `fk_photo_has_rubrique_rubrique1` FOREIGN KEY (`rubrique_id`) REFERENCES `rubriques` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `utilisateur`
--
ALTER TABLE `utilisateur`
  ADD CONSTRAINT `fk_utilisateur_droit1` FOREIGN KEY (`droit_id`) REFERENCES `droit` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
